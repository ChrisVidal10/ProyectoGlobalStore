...
<div id="Principal">
	...
	<div id="Contenido">
								...
								<div id="Texto">
								  <h1>Crear Genero Música</h1>
							
							
							<form id="InsertGenerom" name="InsertGenerom" action="insertGenerom.php" method="POST">

											
												<br>
												<label for ="GEMombre"> Nombre del Genero (Musica): </label>
												<input type="text" name="textGenerom" id ="name" name="name" maxlength="15" />
