...
<div id="Principal">
	...
	<div id="Contenido">
							...
							<form id="InsertCaracteristica" name="InsertCaracteristica" action="insertCaracteristica.php" method="POST">

											
												<br>
												<label for ="CARANombre"> Nombre de la caracteristica: </label>
												<input type="text" name="textCaracteristica" id ="name" name="name" maxlength="15" />
