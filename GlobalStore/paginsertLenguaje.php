...
<div id="Principal">
	...
	<div id="Contenido">
							...
							<form id="InsertLenguaje" name="InsertLenguaje" action="insertLenguaje.php" method="POST">

											
												<br>
												<label for ="ACTNombre"> Nombre del Lenguaje: </label>
												<input type="text" name="textLenguaje" maxlength="15" />
