...
<label style="margin-left:450px">LENGUAJE PELICULA</label>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" class="data_table"> 
    ...
    <?php 
	   ...
	   $g=1;
	   $resultado = mysql_query("SELECT * FROM gs.Leng_Pel");
       $num_registros = mysql_num_rows($resultado); 
	   
                 	while ($g<=$num_registros)
                   	{
							$actpel 	= mysql_query("SELECT LENNombre, CONombre FROM gs.Leng_Pel ap, gs.lenguaje as a, (SELECT * FROM gs.contenido where COTipo = 2) as p WHERE ap.fkLENId=a.LENId and ap.fkCOId=p.COId and ap.fkLENId='$g' group by LENNombre");
