...
<body id="dt_example"> 
    ...
    <label style="margin-left:450px">Caracteristica</label>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" class="data_table"> 
    ...
    <tbody> 
     <?php 
	   ...
	   //$j=1;
	   $g=1;
	   $resultado = mysql_query("SELECT * FROM gs.caracteristica");
       $num_registros = mysql_num_rows($resultado); 
	   
                 	while ($g<=$num_registros)
                   		{
							$cantantes 	= mysql_query("SELECT * FROM gs.caracteristica as f WHERE f.CARAId='$g'");
