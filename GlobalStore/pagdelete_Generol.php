...
<div id="Principal">
	...
	<form id="Delete_Generol" name="DeleteGenerol" action="delete_Generol.php" method="POST">
	</br>
	</br>	
	...
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Generol");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.Generol as L WHERE L.GELId='$i'");
