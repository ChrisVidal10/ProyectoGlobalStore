...
<div id="Principal">
	...
	<form id="Delete_Desarrollador" name="DeleteDesarrollador" action="delete_Imagen.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Imagen: </label>
	</br>
	</br>
    <select name="Imagen">
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.imagen");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.imagen as L WHERE L.IMId='$i'");
