...
<div id="Principal">
	...
	<div id="Contenido">
								...
								<div id="Texto">
								  <h1>Insertar Musica Cantante</h1>
							
							
							<form id="InsertMusic_Can" name="InsertMusic_Can" action="insertMusic_Can.php" method="POST">

														<br>
													<label for="Actor" > Cantante :</label>
																  <select name="FKCANId">
																			<?php 
																				...
																				$co 	= mysql_query("SELECT * FROM   gs.musica_cantante");	
																				$num_registros = mysql_num_rows($co);
																				for ($i=0;$i<=$num_registros;$i++)
																					{
																						$Actor 	= mysql_query("SELECT * FROM gs.cantante as A WHERE A.CANId='$i'");
