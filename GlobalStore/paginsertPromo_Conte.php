...
<div id="Principal">
	...
	<div id="Contenido">
								...
								<div id="Texto">
								  <h1>Insertar Promocion Contenido</h1>
							
							
							<form id="InsertPromo_Conte" name="InsertPromo_Conte" action="insertPromo_Conte.php" method="POST">

														<br>
													<label for="Actor" > Promoción :</label>
																  <select name="FKPRId">
																			<?php 
																				...
																				$co 	= mysql_query("SELECT * FROM   gs.promocion_contenido");	
																				$num_registros = mysql_num_rows($co);
																				for ($i=0;$i<=$num_registros;$i++)
																					{
																						$Actor 	= mysql_query("SELECT * FROM gs.promocion as A WHERE A.PRId='$i'");
												...
												<br>
							  <label for="Pelicula" > Contenido :</label>
																  <select name="FKCOId">
																			<?php 
																				$enlace =  mysql_connect('127.0.0.1', 'root', '');
																				if (!$enlace) 
