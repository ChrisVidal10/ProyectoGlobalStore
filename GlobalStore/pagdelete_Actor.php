...
<div id="Principal">
	...
	<form id="Delete_Actor" name="DeleteActor" action="delete_Actor.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Actor: </label>
	</br>
	</br>
    <select name="Actor">
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Actor");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.Actor as L WHERE L.ACTId='$i'");
