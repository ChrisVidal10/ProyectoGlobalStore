...
<div id="Principal">
	...
	<div id="Contenido">
	<div id="Texto">
	<h1>Eliminar Genero Musica</h1>
	<form id="Delete_Genero_Musica" name="DeleteGenero_Musica" action="delete_Genero_Musica.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Genero Musica: </label>
	</br>
	</br>
	...
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Genero_Musica");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query(" SELECT GEMNombre, CONombre, FKGEMId FROM gs.Genero_Musica ap, gs.generom as a, (SELECT * FROM gs.contenido where COTipo = 3) as p WHERE ap.fkGEMId=a.GEMId and ap.fkCOId=COId and ap.fkGEMId='$i'");
