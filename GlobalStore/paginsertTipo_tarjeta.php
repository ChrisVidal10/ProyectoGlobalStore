...
<div id="Principal">
	...
	<div id="Contenido">
							...
							<form id="InsertTipo_tarjeta" name="InsertTipo_tarjeta" action="insertTipo_tarjeta.php" method="POST">

											
												<br>
												<label for ="TSOombre"> Nombre del Tipo Tarjeta: </label>
												<input type="text" name="textTipo_tarjeta" id ="name" name="name" maxlength="15" />
