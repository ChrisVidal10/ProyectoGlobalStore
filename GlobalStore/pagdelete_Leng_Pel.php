...
<div id="Principal">
	...
	<div id="Contenido">
	<div id="Texto">
	<h1>Eliminar Lenguaje Pelicula</h1>
	<form id="Delete_Leng_Pel" name="DeleteGenero_Leng_Pel" action="delete_Leng_Pel.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Lenguaje Pelicula: </label>
	</br>
	</br>
    <select name="Leng_Pel">
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Leng_Pel");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query(" SELECT LENNombre, CONombre, FKLENId FROM gs.Leng_Pel ap, gs.lenguaje as a, (SELECT * FROM gs.contenido where COTipo = 2) as p WHERE ap.fkLENId=a.LENId and ap.fkCOId=COId and ap.fkLENId='$i'");
