...
<div id="Principal">
	...
	<div id="Contenido">
	<div id="Texto">
	<h1>Eliminar Accion</h1>
	<form id="Delete_Desarrollador" name="DeleteDesarrollador" action="delete_Desarrollador.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Desarrollador: </label>
	</br>
	</br>
