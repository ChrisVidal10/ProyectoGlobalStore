...
<body id="dt_example"> 
    ...
    <label style="margin-left:450px">Reporte 1</label>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" class="data_table"> 
    ...
    SONombre, VENombre, TSONombre
from
    gs.so,
    gs.tipo_so,
    gs.version
where
    FKTSOId = TSOId and FKSOId = SOId;", $enlace);			
			...
			while ($row = mysql_fetch_row($resultado)) //Table body
			{
 				for ($f=1; $f <= $fields; $f++) 
				{
					...
					{				
						...
						<td width='auto' class='center'>".$Version."</td>  
						<td width='auto' class='center'>".$TipoSistema."</td>       
            			</tr>";	
						$control = 1;
					}
					else
