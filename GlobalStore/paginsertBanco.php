...
<div id="Principal">
	...
	<div id="Contenido">
							...
							<form id="InsertBanco" name="InsertBanco" action="insertBanco.php" method="POST">

											
												<br>
												<label for ="BANombre"> Nombre del banco: </label>
												<input type="text" name="textBanco" id ="name" name="name" maxlength="15" />
