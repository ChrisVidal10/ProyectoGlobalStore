...
<label style="margin-left:450px">Genero Libro</label>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" class="data_table"> 
    ...
    <?php 
	   ...
	   $g=1;
	   $resultado = mysql_query("SELECT * FROM gs.Genero_Libro");
       $num_registros = mysql_num_rows($resultado); 
	   
                 	while ($g<=$num_registros)
                   	{
							$actpel 	= mysql_query("SELECT GELNombre, CONombre FROM gs.Genero_Libro ap, gs.generol as a, (SELECT * FROM gs.contenido where COTipo = 4) as p WHERE ap.fkGELId=a.GELId and ap.fkCOId=p.COId and ap.fkGELId='$g' group by GELNombre");
