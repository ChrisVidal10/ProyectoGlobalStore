...
<div id="Principal">
	...
	<div id="Contenido">
	<div id="Texto">
	<h1>Eliminar Promocion</h1>
	<form id="Delete_Promocion" name="DeletePromocion" action="delete_Promocion.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Promocion: </label>
	</br>
	</br>
	...
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.promocion");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.promocion as L WHERE L.PRId='$i'");
