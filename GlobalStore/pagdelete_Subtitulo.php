...
<div id="Principal">
	...
	<div id="Contenido">
	<div id="Texto">
	<h1>Eliminar Subtitulo</h1>
	<form id="Delete_Subtitulo" name="DeleteSubtitulo" action="delete_Subtitulo.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Subtitulo: </label>
	</br>
	</br>
	...
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Subtitulo");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.Subtitulo as L WHERE L.SUBId='$i'");
