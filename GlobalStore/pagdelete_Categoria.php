...
<div id="Principal">
	...
	<form id="Delete_Categoria" name="DeleteCategoria" action="delete_Categoria.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Categoria: </label>
	</br>
	</br>
	...
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Categoria");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.Categoria as L WHERE L.CATId='$i'");
