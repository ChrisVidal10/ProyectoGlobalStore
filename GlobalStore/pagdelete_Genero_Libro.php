...
<div id="Principal">
	...
	<div id="Contenido">
	<div id="Texto">
	<h1>Eliminar Genero Libro</h1>
	<form id="Delete_Genero_Libro" name="DeleteGenero_Libro" action="delete_Genero_Libro.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Genero Libro: </label>
	</br>
	</br>
	...
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Genero_Libro");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query(" SELECT GELNombre, CONombre, FKGELId FROM gs.Genero_Libro ap, gs.generol as a, (SELECT * FROM gs.contenido where COTipo = 4) as p WHERE ap.fkGELId=a.GELId and ap.fkCOId=COId and ap.fkGELId='$i'");
