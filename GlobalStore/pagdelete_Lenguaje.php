...
<div id="Principal">
	...
	<div id="Contenido">
	<div id="Texto">
	<h1>Eliminar Lenguaje</h1>
	<form id="Delete_Lenguaje" name="DeleteLenguaje" action="delete_Lenguaje.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Lenguaje: </label>
	</br>
	</br>
	...
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Lenguaje");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.lenguaje as L WHERE L.LENId='$i'");
