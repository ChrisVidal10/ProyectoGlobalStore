...
<div id="Principal">
	...
	<form id="Delete_Desarrollador" name="DeleteDesarrollador" action="delete_Video.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Video: </label>
	</br>
	</br>
    <select name="Video">
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.video");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.video as L WHERE L.VIDId='$i'");
