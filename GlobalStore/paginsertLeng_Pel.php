...
<div id="Principal">
	...
	<div id="Contenido">
								...
								<div id="Texto">
								  <h1>Insertar Lenguaje Pelicula</h1>
							
							
							<form id="InsertLeng_Pel" name="InsertLeng_Pel" action="insertLeng_Pel.php" method="POST">

														<br>
													<label for="Actor" > Lenguaje :</label>
																  <select name="FKLENId">
																			<?php 
																				...
																				$co 	= mysql_query("SELECT * FROM gs.Leng_Pel");	
																				$num_registros = mysql_num_rows($co);
																				for ($i=0;$i<=$num_registros;$i++)
																					{
																						$Actor 	= mysql_query("SELECT * FROM gs.lenguaje as A WHERE A.LENId='$i'");
