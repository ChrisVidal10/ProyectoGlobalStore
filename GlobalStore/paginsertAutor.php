...
<div id="Principal">
	...
	<div id="Contenido">
							...
							<form id="InsertAutor" name="InsertAutor" action="insertAutor.php" method="POST">

											
												<br>
												<label for ="AUNombre"> Nombre del autor: </label>
												<input type="text" name="textAutor" maxlength="15" />
