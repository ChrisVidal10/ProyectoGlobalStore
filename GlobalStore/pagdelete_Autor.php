...
<div id="Principal">
	...
	<form id="Delete_Autor" name="DeleteAutor" action="delete_Autor.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Autor: </label>
	</br>
	</br>
    <select name="Autor">
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Autor");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.autor as L WHERE L.AUId='$i'");
