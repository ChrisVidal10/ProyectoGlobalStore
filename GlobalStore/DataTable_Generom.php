...
<body id="dt_example"> 
    ...
    <label style="margin-left:450px">Generom</label>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" class="data_table"> 
    ...
    <tbody> 
     <?php 
	   ...
	   //$j=1;
	   $g=1;
	   $resultado = mysql_query("SELECT * FROM gs.Generom");
       $num_registros = mysql_num_rows($resultado); 
	   
                 	while ($g<=$num_registros)
                   		{
							$Director 	= mysql_query("SELECT * FROM gs.Generom as f WHERE f.GEMId='$g'");
