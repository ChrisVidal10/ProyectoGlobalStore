...
<div id="Principal">
	...
	<form id="Delete_Director" name="DeleteDirector" action="delete_Director.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Director: </label>
	</br>
	</br>
	...
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Director");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.Director as L WHERE L.DIId='$i'");
