...
<div id="Principal">
	...
	<form id="Delete_Generom" name="DeleteGenerom" action="delete_Generom.php" method="POST">
	</br>
	</br>	
	...
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Generom");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.Generom as L WHERE L.GEMId='$i'");
