...
<div id="Principal">
	...
	<form id="Delete_Banco" name="DeleteBanco" action="delete_Banco.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Banco: </label>
	</br>
	</br>
    <select name="Banco">
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Banco");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.Banco as L WHERE L.BANId='$i'");
