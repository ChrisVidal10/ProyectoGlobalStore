...
<div id="Principal">
	...
	<div id="Contenido">
	<div id="Texto">
	<h1>Eliminar Tipo SO</h1>
	<form id="Delete_Tipo_so" name="DeleteTipo_so" action="delete_Tipo_so.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Tipo SO: </label>
	</br>
	</br>
    <select name="Tipo_so">
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Tipo_so");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.Tipo_so as L WHERE L.TSOId='$i'");
