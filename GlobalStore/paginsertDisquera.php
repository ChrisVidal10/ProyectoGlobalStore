...
<div id="Principal">
	...
	<div id="Contenido">
								...
								<div id="Texto">
								  <h1>Crear Disquera</h1>
							
							
							<form id="InsertDisquera" name="InsertDisquera" action="insertDisquera.php" method="POST">

											
												<br>
												<label for ="DIombre"> Nombre de la Disquera: </label>
												<input type="text" name="textDisquera" id ="name" name="name" maxlength="15" />
