...
<div id="Principal">
	...
	<div id="Contenido">
								...
								<div id="Texto">
								  <h1>Crear Subtitulo</h1>
							
							
							<form id="InsertSubtitulo" name="InsertSubtitulo" action="insertSubtitulo.php" method="POST">

											
												<br>
												<label for ="SUBombre"> Nombre del Subtitulo: </label>
												<input type="text" name="textSubtitulo" id ="name" name="name" maxlength="15" />
