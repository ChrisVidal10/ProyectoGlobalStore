...
<div id="Principal">
	...
	<div id="Contenido">
							...
							<form id="InsertCargo" name="InsertCargo" action="insertCargo.php" method="POST">

											
												</br>
												<label for ="CARDescripcion"> Descripcion del cargo: </label>
												<input type="text" name="textCargoDescripcion" maxlength="15" />
												 </br>
												<label for ="CARSalario"> Salario : </label>
												<input type="Number" name="numberSalario" maxlength="15" min="3000" />
												</br>
