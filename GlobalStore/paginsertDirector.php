...
<div id="Principal">
	...
	<div id="Contenido">
							...
							<form id="InsertDirector" name="InsertDirector" action="insertDirector.php" method="POST">

											
												<br>
												<label for ="DIombre"> Nombre del Director: </label>
												<input type="text" name="textDirector" id ="name" name="name" maxlength="15" />
