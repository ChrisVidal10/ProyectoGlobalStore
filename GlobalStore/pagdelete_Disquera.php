...
<div id="Principal">
	...
	<div id="Contenido">
	<div id="Texto">
	<h1>Eliminar Disquera</h1>
	<form id="Delete_Disquera" name="DeleteDisquera" action="delete_Disquera.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Disquera: </label>
	</br>
	</br>
	...
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Disquera");	
