...
<div id="Principal">
	...
	<div id="Contenido">
							...
							<form id="InsertEditorial" name="InsertEditorial" action="insertEditorial.php" method="POST">

											
												<br>
												<label for ="EDombre"> Nombre de la Editorial: </label>
												<input type="text" name="textEditorial" id ="name" name="name" maxlength="15" />
