...
<div id="Principal">
	...
	<div id="Contenido">
								...
								<div id="Texto">
								  <h1>Insertar Actor Pelicula</h1>
							
							
							<form id="InsertActor_Pelicula" name="InsertActor_Pelicula" action="insertActor_Pelicula.php" method="POST">
													...
													<label for="Actor" > Actor :</label>
																  <select name="FKACTId">
																			<?php 
																				...
																				$co 	= mysql_query("SELECT * FROM gs.actor");	
																				$num_registros = mysql_num_rows($co);
																				for ($i=0;$i<=$num_registros;$i++)
																					{
																						$Actor 	= mysql_query("SELECT * FROM gs.actor as A WHERE A.ACTId='$i'");
