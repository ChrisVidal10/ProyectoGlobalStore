...
<div id="Principal">
	...
	<div id="Contenido">
	<div id="Texto">
	<h1>Eliminar Caracteristica</h1>
	<form id="Delete_Banco" name="DeleteCantante" action="delete_Caracteristica.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Caracteristica: </label>
	</br>
	</br>
	...
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.caracteristica");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.Caracteristica as L WHERE L.CARAId='$i'");
