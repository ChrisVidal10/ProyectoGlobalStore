...
<div id="Principal">
	...
	<div id="Contenido">
	<div id="Texto">
	<h1>Eliminar Musica Cantante</h1>
	<form id="Delete_Libro_Autor" name="DeleteGenero_Libro_Autor" action="delete_Libro_Autor.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Libro Autor: </label>
	</br>
	</br>
    <select name="musica_cantante">
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.musica_cantante");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query(" SELECT CANNombre, CONombre, FKCANId FROM gs.musica_cantante ap, gs.cantante as a, (SELECT * FROM gs.contenido where COTipo = 3) as p WHERE ap.fkCANId=a.CANId and ap.fkCOId=COId and ap.fkCANId='$i'");
