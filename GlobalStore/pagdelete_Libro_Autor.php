...
<div id="Principal">
	...
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Libro_Autor");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query(" SELECT AUNombre, CONombre, FKAUId FROM gs.Libro_Autor ap, gs.autor as a, (SELECT * FROM gs.contenido where COTipo = 4) as p WHERE ap.fkAUId=a.AUId and ap.fkCOId=COId and ap.fkAUId='$i'");
