...
<div id="Principal">
	...
	<div id="Contenido">
							...
							<form id="InsertCategoria" name="InsertCategoria" action="insertCategoria.php" method="POST">

											
												<br>
												<label for ="CATombre"> Nombre de la Categoria: </label>
												<input type="text" name="textCategoria" id ="name" name="name" maxlength="15" />
