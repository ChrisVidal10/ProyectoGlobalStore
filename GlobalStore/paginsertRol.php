...
<div id="Principal">
	...
	<div id="Contenido">
							...
							<form id="InsertRol" name="InsertRol" action="insertRol.php" method="POST">

											
												<br>
												<label for ="ROombre"> Nombre del Rol: </label>
												<input type="text" name="textRol" id ="name" name="name" maxlength="15" />
