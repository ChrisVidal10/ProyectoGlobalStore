...
<body id="dt_example"> 
    ...
    <label style="margin-left:450px">Historial</label>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" class="data_table"> 
    ...
    <?php 
	   ...
	   $g=1;
	   $resultado = mysql_query("SELECT * FROM gs.historial");
       $num_registros = mysql_num_rows($resultado); 
	   
                 	while ($g<=$num_registros)
                   	{
							$contrato 	= mysql_query("SELECT * FROM gs.historial as e WHERE e.HISTId='$g'");
							...
							<td width='auto' class='center'>".$tipo."</td> 
							<td width='auto' class='center'>".$persona."</td> 
							<td width='auto' class='center'>".$accion."</td>
							<td width='auto' class='center'>".$rol."</td> 
