...
<div id="Principal">
	...
	<div id="Contenido">
	<div id="Texto">
	<h1>Eliminar Tipo Tarjeta</h1>
	<form id="Delete_Tipo_tarjeta" name="DeleteTipo_tarjeta" action="delete_Tipo_tarjeta.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Tipo Tarjeta: </label>
	</br>
	</br>
	...
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.Tipo_tarjeta");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.Tipo_tarjeta as L WHERE L.TTId='$i'");
