...
<div id="Principal">
	...
	<div id="Contenido">
								...
								<div id="Texto">
								  <h1>Insertar Libro Autor</h1>
							
							
							<form id="InsertLibro_Autor" name="InsertLibro_Autor" action="insertLibro_Autor.php" method="POST">

														<br>
													<label for="Actor" > Autor :</label>
																  <select name="FKAUId">
																			<?php 
																				...
																				$co 	= mysql_query("SELECT * FROM gs.Libro_Autor");	
																				$num_registros = mysql_num_rows($co);
																				for ($i=0;$i<=$num_registros;$i++)
																					{
																						$Actor 	= mysql_query("SELECT * FROM gs.autor as A WHERE A.AUId='$i'");
