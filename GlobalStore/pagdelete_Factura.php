...
<div id="Principal">
	...
	<form id="Delete_Factura" name="DeleteFactura" action="delete_Factura.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Factura: </label>
	</br>
	</br>
    <select name="Factura">
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.factura");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.factura as L WHERE L.FAId='$i'");
