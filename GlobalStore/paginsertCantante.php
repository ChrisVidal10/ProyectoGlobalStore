...
<div id="Principal">
	...
	<div id="Contenido">
								...
								<div id="Texto">
								  <h1>Crear Cantante</h1>
							
							
							<form id="InsertCantante" name="InsertCantante" action="insertCantante.php" method="POST">

											
												<br>
												<label for ="CANNombre"> Nombre del cantante: </label>
												<input type="text" name="textCantante" id ="name" name="name" maxlength="15" />
