...
<label style="margin-left:450px">Director Pelicula</label>
    ...
    <?php 
       ...
       $num_registros = mysql_num_rows($resultado); 
                 	...
                 	while ($g<=$num_registros)
                   	{
							$actpel 	= mysql_query("SELECT DINombre, CONombre FROM gs.Director_Pelicula ap, gs.director as a, (SELECT * FROM gs.contenido where COTipo = 2) as p WHERE ap.FKDIId=a.DIId and ap.FKCOId=p.COId and ap.FKDIId='$g' group by DINombre");
