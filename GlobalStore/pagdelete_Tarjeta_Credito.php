...
<div id="Principal">
	...
	<div id="Contenido">
	<div id="Texto">
	<h1>Eliminar Tarjeta de Credito</h1>
	<form id="Delete_Tarjeta_Credito" name="DeleteTarjeta_Credito" action="delete_Tarjeta_Credito.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Tarjeta de Credito: </label>
	</br>
	</br>
    <select name="TDCNumeroTarjeta">
	<?php 
