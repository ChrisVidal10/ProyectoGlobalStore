...
<div id="Principal">
	...
	<div id="Contenido">
							...
							<form id="InsertLugar" name="InsertLugar" action="InsertLugar.php" method="POST">

			
												</br>
												
												<label for ="LUTipo">Tipo de lugar: </label>
												<input type="number" name="LUTipo"  />
												</br>	
												<label for ="LUDescripcion"> Nombre del Lugar : </label>
												<input type="text" name="LUNombre" />
												</br>
												<label for ="LUCodigo_Postal"> Codigo postal: </label>
												<input type="text" name="LUCodigo_Postal"  />
												 </br>
															
												
												
														<br>
														<label for ="FKLUId"> Foranea de lugar: </label>
															<select name="FKLUId" >
																			...
																			<?php 
																				...
																				$Us 	= mysql_query("SELECT * FROM gs.lugar");	
																				$num_registros = mysql_num_rows($Us);
																				for ($i=0;$i<=$num_registros;$i++)
																					{
																						$modelo 	= mysql_query("SELECT * FROM gs.lugar as L WHERE L.FKLUId='$i'");
