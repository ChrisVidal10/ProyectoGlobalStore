...
<div id="Principal">
	...
	<div id="Contenido">
							...
							<form id="InsertTipo_so" name="InsertTipo_so" action="insertTipo_so.php" method="POST">

											
												<br>
												<label for ="TSOombre"> Nombre del Tipo SO: </label>
												<input type="text" name="textTipo_so" id ="name" name="name" maxlength="15" />
