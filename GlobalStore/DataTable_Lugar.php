...
<label style="margin-left:450px">Lugar</label>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" class="data_table"> 
    <thead> 
        <tr>
        (LUid,LUtipo,LUNombre,FKLUid)
            <th width="auto">LUid</th> 
            <th width="auto">LUtipo</th>
            <th width="auto">LUdescripcion</th>  
            <th width="auto">FKLUid</th>
            </tr> 
    </thead> 
    <tbody> 
     <?php 
	   ...
	   //$j=1;
	   $g=1;
	   $resultado = mysql_query("SELECT * FROM gs.lugar");
       $num_registros = mysql_num_rows($resultado); 
	   
                 	while ($g<=$num_registros)
                   		{
							$Personas 	= mysql_query("SELECT * FROM gs.lugar as f WHERE f.LUid='$g'");
							$arreglo 	= mysql_fetch_row($Personas);
			...
			<td width='auto' class='center'>".$identificador."</td> 
			<td width='auto' class='center'>".$nombre."</td>
			<td width='auto' class='center'>".$fechaini."</td>
			<td width='auto' class='center'>".$fechafin."</td> 
			<td width='auto' class='center'>".$valor."</td>
			</tr>";
			$g++; 
       } 
