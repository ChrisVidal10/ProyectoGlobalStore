...
<label style="margin-left:450px">VERSION CARACTERISTICA</label>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" class="data_table"> 
    <thead> 
        <tr> 
            ...
            <th width="auto">Caracteristica</th> 
        </tr> 
    </thead> 
    <tbody> 
    <?php 
	   ...
	   $g=1;
	   $resultado = mysql_query("SELECT * FROM gs.version_car");
       $num_registros = mysql_num_rows($resultado); 
	   
                 	while ($g<=$num_registros)
                   	{
							$actpel 	= mysql_query("SELECT VENombre, CARANombre FROM gs.version_car vc, gs.version v, gs.caracteristica ca WHERE vc.fkVEId=v.VEId and vc.fkCARAId=ca.CARAId and vc.fkVEId='$g' group by VENombre");
