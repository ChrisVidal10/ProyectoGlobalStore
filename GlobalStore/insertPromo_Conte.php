<?php
	...
	else
	{
   		...
   		if (!$enlace) 
		{
 	 	...
 	 	$Respuesta = mysql_query("SELECT AP.* FROM gs.promocion_contenido AP WHERE AP.FKPRId='$FKPRId' and  AP.FKCOId='$FKCOId';");
		$arreglo = mysql_fetch_row($Respuesta);
		if (( $arreglo[0]==$FKPRId) and ( $arreglo[1]==$FKCOId) )
		{
		...
		{ 
			...
			$query=("insert into gs.promocion_contenido(FKPRId,FKCOId) values ('$FKPRId','$FKCOId')");
