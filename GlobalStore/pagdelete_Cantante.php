...
<div id="Principal">
	...
	<div id="Contenido">
	<div id="Texto">
	<h1>Eliminar Cantante</h1>
	<form id="Delete_Banco" name="DeleteCantante" action="delete_Cantante.php" method="POST">
	</br>
	</br>	
	<label for ="LUDescripcion"> Cantante: </label>
	</br>
	</br>
	...
	<?php 
		...
		$Us 	= mysql_query("SELECT * FROM gs.cantante");	
		$num_registros = mysql_num_rows($Us);
		for ($i=0;$i<=$num_registros;$i++)
		{
		$modelo 	= mysql_query("SELECT * FROM gs.Cantante as L WHERE L.CANId='$i'");
