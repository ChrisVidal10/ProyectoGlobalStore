...
<div id="Principal">
	...
	<div id="Contenido">
							...
							<form id="InsertGenerol" name="InsertGenerol" action="insertGenerol.php" method="POST">

											
												<br>
												<label for ="GELombre"> Nombre del Genero (Libro): </label>
												<input type="text" name="textGenerol" id ="name" name="name" maxlength="15" />
