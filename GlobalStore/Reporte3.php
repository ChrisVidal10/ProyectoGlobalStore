...
<label style="margin-left:450px">Reporte 3</label>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" class="data_table"> 
    ...
    <tbody> 
     <?php
		...
		$resultado = mysql_query("select p.PERCedula,p.PERPnombre,p.PERPapellido, p.pemstatus from gs.persona p where p.PERTipo=1;", $enlace);			
