...
<div id="Principal">
	...
	<div id="Contenido">
								...
								<div id="Texto">
								  <h1>Insertar Director Pelicula</h1>
							
							
							<form id="InsertDirector_Pelicula" name="InsertDirector_Pelicula" action="insertDirector_Pelicula.php" method="POST">
													...
													<label for="Actor" > Director :</label>
																  <select name="FKACTId">
																			<?php 
																				...
																				$co 	= mysql_query("SELECT * FROM gs.director");	
																				$num_registros = mysql_num_rows($co);
																				for ($i=0;$i<=$num_registros;$i++)
																					{
																						$Actor 	= mysql_query("SELECT * FROM gs.director as A WHERE A.DIId='$i'");
