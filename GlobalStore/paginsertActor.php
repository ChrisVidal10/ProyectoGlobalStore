...
<div id="Principal">
	...
	<div id="Contenido">
							...
							<form id="InsertActor" name="InsertActor" action="insertActor.php" method="POST">

											
												<br>
												<label for ="ACTNombre"> Nombre del actor: </label>
												<input type="text" name="textActor" maxlength="15" />
